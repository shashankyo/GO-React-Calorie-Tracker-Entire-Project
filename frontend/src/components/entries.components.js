...
const Entries =() =>{
    ...
    return(
        <><div>
            ...
            <Modal show={changeIngredient.change} onHide={() => setChangeIngredient({ "change": false, "id": 0 })} centred></Modal>
            <Modal.Header closeButton>
        ...
        </div><Modal show={changeEntry.change} onHide={() => setChangeEntry({ "change": false, "id": 0 })} centred>
                <Modal.Header closeButton>
